...
def cookies_to_netscape(cookies: list[dict], output_path: Path) -> None:
    """Export cookies in Netscape format for yt-dlp compatibility."""
    lines = ["# Netscape HTTP Cookie File", "# Generated by flarecrawl", ""]
    for c in cookies:
        domain = c.get("domain", "")
